...
import tools.data_ada as data_ada
import tools.models as models
from tools.models import ReverseLayerF
...
def loadData(opts, batch_size, cuda):
    ...
    src_loader, inp_shape_1 = data_ada.loader(source, target_byte, src_aw, batch_size, trace_num_src, 0      , leakage_model, kwargs)
    tar_loader, inp_shape_2 = data_ada.loader(target, target_byte, tar_aw, batch_size, trace_num_tar, shifted, leakage_model, kwargs)

    return src_loader, tar_loader, inp_shape_1
...
def train(opts, epoch, model, source_loader, target_loader, batch_size, learning_rate, cuda):
    ...
    for i in range(1, len_source_loader+1):
        ...
        source_data, source_label, textin = data_source_iter.next()
        ...
        target_data, target_label, textin = data_target_iter.next()
