...
def loadData(opts, batch_size, cuda):
    ...
    source_loader, inp_shape_1 = data_ada.loader(source, target_byte, src_attack_window, batch_size, trace_num_src, 0, leakage_model, kwargs)
    target_loader, inp_shape_2 = data_ada.loader(target, target_byte, tar_attack_window, batch_size, trace_num_tar, shifted, leakage_model, kwargs)
    return source_loader, target_loader, inp_shape_1
