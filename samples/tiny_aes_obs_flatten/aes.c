...
{ 
  uint8_t i ;
  uint8_t j ;
  unsigned long _1_SubBytes_next ;

  {
  {
  _1_SubBytes_next = 4UL;
  }
  while (1) {
    switch (_1_SubBytes_next) {
    case 4: 
    i = (uint8_t )0;
    {
    _1_SubBytes_next = 2UL;
    }
    break;
    case 8: 
    j = (uint8_t )0;
    {
    _1_SubBytes_next = 3UL;
    }
    break;
    case 1: 
    ...
    if ((int )j < 4) {
      {
      _1_SubBytes_next = 1UL;
      }
    } else {
      {
      _1_SubBytes_next = 10UL;
      }
    }
    break;
    case 5: ;
    ...
    if ((int )i < 4) {
      {
      _1_SubBytes_next = 8UL;
      }
    } else {
      {
      _1_SubBytes_next = 5UL;
      }
    }
    break;
    }
