...
void _1_SubBytes_SubBytes_split_2(uint8_t *i , uint8_t *j ) ;
...
void _1_SubBytes_SubBytes_split_1(uint8_t *i ) ;
...
{ 
  ...
  {
  _1_SubBytes_SubBytes_split_1(& i);
  _1_SubBytes_SubBytes_split_2(& i, & j);
  return;
}
}
static void KeyExpansion(void) 
