...
{ 
  ...
  {
  i = (uint8_t )0;
  while (((unsigned int )((((4 - (int )i) & - (4 >= (int )i)) >> 31) - (((4 - (int )i) & - (4 >= (int )i)) ^ (((4 - (int )i) & - (4 >= (int )i)) >> 31))) >> 31U) & 1) {
    j = (uint8_t )0;
    while (((unsigned int )(((((4 - (int )j) & - (4 >= (int )j)) >> 31) - ((4 - (int )j) & - (4 >= (int )j))) ^ (((4 - (int )j) & - (4 >= (int )j)) >> 31)) >> 31U) & 1) {
...
{ 
  ...
  sbox[101] = (uint8_t )77;
  sbox[102] = (uint8_t )51;
  sbox[103] = (uint8_t )133;
  sbox[104] = (uint8_t )69;
  sbox[105] = (uint8_t )249;
  sbox[106] = (uint8_t )2;
  sbox[107] = (uint8_t )127;
  sbox[108] = (uint8_t )80;
  sbox[109] = (uint8_t )60;
  sbox[110] = (uint8_t )159;
  sbox[111] = (uint8_t )168;
  sbox[112] = (uint8_t )81;
  sbox[113] = (uint8_t )163;
  sbox[114] = (uint8_t )64;
  sbox[115] = (uint8_t )143;
  sbox[116] = (uint8_t )146;
  sbox[117] = (uint8_t )157;
  sbox[118] = (uint8_t )56;
  sbox[119] = (uint8_t )245;
  sbox[120] = (uint8_t )188;
  sbox[121] = (uint8_t )182;
  sbox[122] = (uint8_t )218;
  sbox[123] = (uint8_t )33;
  sbox[124] = (uint8_t )16;
  sbox[125] = (uint8_t )255;
  sbox[126] = (uint8_t )243;
  sbox[127] = (uint8_t )210;
  sbox[128] = (uint8_t )205;
  sbox[129] = (uint8_t )12;
  sbox[130] = (uint8_t )19;
  sbox[131] = (uint8_t )236;
  sbox[132] = (uint8_t )95;
  sbox[133] = (uint8_t )151;
  sbox[134] = (uint8_t )68;
  sbox[135] = (uint8_t )23;
  sbox[136] = (uint8_t )196;
  sbox[137] = (uint8_t )167;
  sbox[138] = (uint8_t )126;
  sbox[139] = (uint8_t )61;
  sbox[140] = (uint8_t )100;
  sbox[141] = (uint8_t )93;
  sbox[142] = (uint8_t )25;
  sbox[143] = (uint8_t )115;
  sbox[144] = (uint8_t )96;
  sbox[145] = (uint8_t )129;
  sbox[146] = (uint8_t )79;
  sbox[147] = (uint8_t )220;
  sbox[148] = (uint8_t )34;
  sbox[149] = (uint8_t )42;
  sbox[150] = (uint8_t )144;
  sbox[151] = (uint8_t )136;
  sbox[152] = (uint8_t )70;
  sbox[153] = (uint8_t )238;
  sbox[154] = (uint8_t )184;
  sbox[155] = (uint8_t )20;
  sbox[156] = (uint8_t )222;
  sbox[157] = (uint8_t )94;
  sbox[158] = (uint8_t )11;
  sbox[159] = (uint8_t )219;
  sbox[160] = (uint8_t )224;
  sbox[161] = (uint8_t )50;
  sbox[162] = (uint8_t )58;
  sbox[163] = (uint8_t )10;
  sbox[164] = (uint8_t )73;
  ...
  sbox[166] = (uint8_t )36;
  sbox[167] = (uint8_t )92;
  sbox[168] = (uint8_t )194;
  sbox[169] = (uint8_t )211;
  sbox[170] = (uint8_t )172;
  sbox[171] = (uint8_t )98;
  sbox[172] = (uint8_t )145;
  sbox[173] = (uint8_t )149;
  sbox[174] = (uint8_t )228;
  sbox[175] = (uint8_t )121;
  sbox[176] = (uint8_t )231;
  sbox[177] = (uint8_t )200;
  sbox[178] = (uint8_t )55;
  sbox[179] = (uint8_t )109;
  sbox[180] = (uint8_t )141;
  sbox[181] = (uint8_t )213;
  sbox[182] = (uint8_t )78;
  sbox[183] = (uint8_t )169;
  sbox[184] = (uint8_t )108;
  sbox[185] = (uint8_t )86;
  sbox[186] = (uint8_t )244;
  sbox[187] = (uint8_t )234;
  sbox[188] = (uint8_t )101;
  sbox[189] = (uint8_t )122;
  sbox[190] = (uint8_t )174;
  sbox[191] = (uint8_t )8;
  sbox[192] = (uint8_t )186;
  sbox[193] = (uint8_t )120;
  sbox[194] = (uint8_t )37;
  sbox[195] = (uint8_t )46;
  sbox[196] = (uint8_t )28;
  sbox[197] = (uint8_t )166;
  sbox[198] = (uint8_t )180;
  sbox[199] = (uint8_t )198;
  sbox[200] = (uint8_t )232;
  sbox[201] = (uint8_t )221;
  sbox[202] = (uint8_t )116;
  sbox[203] = (uint8_t )31;
  sbox[204] = (uint8_t )75;
  sbox[205] = (uint8_t )189;
  sbox[206] = (uint8_t )139;
  sbox[207] = (uint8_t )138;
  sbox[208] = (uint8_t )112;
  sbox[209] = (uint8_t )62;
  sbox[210] = (uint8_t )181;
  sbox[211] = (uint8_t )102;
  sbox[212] = (uint8_t )72;
  sbox[213] = (uint8_t )3;
  sbox[214] = (uint8_t )246;
  sbox[215] = (uint8_t )14;
  sbox[216] = (uint8_t )97;
  sbox[217] = (uint8_t )53;
  sbox[218] = (uint8_t )87;
  sbox[219] = (uint8_t )185;
  sbox[220] = (uint8_t )134;
  sbox[221] = (uint8_t )193;
  sbox[222] = (uint8_t )29;
  sbox[223] = (uint8_t )158;
  sbox[224] = (uint8_t )225;
  sbox[225] = (uint8_t )248;
  sbox[226] = (uint8_t )152;
  sbox[227] = (uint8_t )17;
  sbox[228] = (uint8_t )105;
  sbox[229] = (uint8_t )217;
  sbox[230] = (uint8_t )142;
  sbox[231] = (uint8_t )148;
  sbox[232] = (uint8_t )155;
  sbox[233] = (uint8_t )30;
  sbox[234] = (uint8_t )135;
  sbox[235] = (uint8_t )233;
  sbox[236] = (uint8_t )206;
  sbox[237] = (uint8_t )85;
  sbox[238] = (uint8_t )40;
  sbox[239] = (uint8_t )223;
  sbox[240] = (uint8_t )140;
  sbox[241] = (uint8_t )161;
  sbox[242] = (uint8_t )137;
  sbox[243] = (uint8_t )13;
  sbox[244] = (uint8_t )191;
  sbox[245] = (uint8_t )230;
  sbox[246] = (uint8_t )66;
  sbox[247] = (uint8_t )104;
  sbox[248] = (uint8_t )65;
  sbox[249] = (uint8_t )153;
  sbox[250] = (uint8_t )45;
  sbox[251] = (uint8_t )15;
  sbox[252] = (uint8_t )176;
  sbox[253] = (uint8_t )84;
  sbox[254] = (uint8_t )187;
  sbox[255] = (uint8_t )22;
}
}
static uint8_t xtime(uint8_t x ) 
